...
        /*
		{
			name: "GitHub",
			url: "https://github.com/Cirnoqwa", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	avatar: "/public/assets/images/avatar.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "RadiumCoffee",
	bio: "Somnia",
	links: [
		{
